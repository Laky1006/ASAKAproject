      ...
      >
        ...
        <div class="px-6 py-4 space-y-2 font-heading">
          ...
          <div v-if="user" class="border-t border-[#e8e5e2]/50 pt-4 mt-4">
            ...
            <!-- Saved Services (Mobile) -->
            <Link :href="route('saved-services.index')" @click="showMobileMenu = false"
              class="block py-3 px-4 text-[#6b5b73] hover:text-[#e4299c] hover:bg-[#e4299c]/10 transition-colors rounded-xl font-semibold">
      ...
      >
        ...
        <nav class="hidden sm:flex items-center gap-8 lg:gap-10 text-lg lg:text-xl text-[#6b5b73] font-heading">
          ...
          <div v-if="user" class="relative" ref="dropdown">
            ...
            <div v-if="showMenu"
              class="absolute right-0 mt-2 w-48 bg-white/90 backdrop-blur-md text-[#6b5b73] shadow-xl rounded-lg overflow-hidden z-50 border border-[#e8e5e2] font-body font-normal"
            >
              ...
              <!-- Saved Services (Desktop) -->
              <Link v-if="user.role === 'reguser'" :href="route('saved-services.index')" class="flex items-center gap-2 px-4 py-3 hover:bg-[#f8f6f4] hover:text-[#e4299c] transition-colors">
                Saved Services
              </Link>
